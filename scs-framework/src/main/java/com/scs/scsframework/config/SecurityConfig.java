package com.scs.scsframework.config;

import com.scs.scsframework.component.AccessDecisionProcessor;
import com.scs.scsframework.filter.JwtAuthenticationTokenFilter;
import com.scs.scsframework.component.RestAuthenticationEntryPoint;
import com.scs.scsframework.component.RestfulAccessDeniedHandler;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                // 放行登录方法
                .antMatchers("/authentication/getCode").permitAll()
